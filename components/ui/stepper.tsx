...
function StepperIndicator({
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "relative flex items-center justify-center size-9 shrink-0 overflow-hidden rounded-full text-xs font-bold border",
        // inactive (default)
        "bg-white text-inactivecolor  border-inactivecolor dark:bg-background",

        // active
        "data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:border-primary",

        // completed
        "data-[state=completed]:bg-white data-[state=completed]:text-primary data-[state=completed]:border-primary",
